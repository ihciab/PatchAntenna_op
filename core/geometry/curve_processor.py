...
重构说明：
- 将原 ReshapeContour 类重构为 CurveProcessor 类
- 保持原有算法和逻辑完全不变
"""
import numpy as np
import pandas as pd
...
class CurveProcessor:
    """
    曲线处理器类
    原类：Sweep/ReshapeContour.py 中的 ReshapeContour
