...
class Simulation:
    def __init__(self, instance_dict, color_ranges=None):
        ...
        # self.__Contours_dict = None
        self.newcons_dict = None
        # self.__Curves_tree = None
    ...
    def __start_solve(self, folder_path, project_name):
        ...
        if solver:
            ...
            with open(folder_path + f'\\{project_name}_s11.txt', 'w', encoding='utf-8') as f:
                print(s11, file=f)
            with open(folder_path + f'\\{project_name}_s12.txt', 'w', encoding='utf-8') as f:
                print(s12, file=f)
        else:
...
if __name__ == '__main__':
    Instance_dict = {
        'Folder_path': r"D:\CST2023proj\autocst_MA\202604141654",
        'Instance': 'Microstrip_Antenna',
        'mode': 'S',
        'Units': ['mm', 'GHz'],
        'FSS_package': {'X': 36, 'Y': 36, 'f0': 6, 'f1': 14},
        'layers': {
            'layer0': {'img_path': r"D:\pyproject\Auto_py2cst_test\test\test47.png",
                       'substrate': 0.6,
                       'gnd': True,
                       'col_mats': {
                           'white': 'FR4',
